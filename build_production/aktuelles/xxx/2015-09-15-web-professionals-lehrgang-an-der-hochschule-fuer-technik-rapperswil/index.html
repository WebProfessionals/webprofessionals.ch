    ...
    <div class="background">
        ...
        <div class="container">
            <div class="row">
                <div class="col s12">
                    <header>
                        <span class="webpro-h1-before">Update</span>
                        <h1 class="webpro">Web Professionals Lehrgang an der Hochschule f&uuml;r Technik Rapperswil</h1>
                    </header>            Rolf Eggenberger, 15. September 2015
                </div>
                <div class="col l4 m5">
