    ...
    <div class="background">
        ...
        <div class="container">
            <div class="row">
                <div class="col s12">
                    <header>
                        <span class="webpro-h1-before">R&uuml;ckblick</span>
                        <h1 class="webpro">Web Professionals Winter Camp 2016</h1>
                    </header>            Marianne Venzin, somedia Production, 2. März 2016
                </div>
                <div class="col l4 m5">
                    <br>
