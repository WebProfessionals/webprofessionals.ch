...
{{-- Header --}}
@section('header')
    <title>WordPress Theme Development und der Gutenberg-Editor | Kurs | Web Professionals</title>
...
@section('hero')
    ...
    <header class="webpro-hero">
        ...
        <div class="webpro-hero-claim">
            <span class="webpro-hero1">WordPress Theme Development und der Gutenberg-Editor</span><br>
            <span class="webpro-hero2">Mache Deine Themes bereit für die Zukunft!</span><br><br>
        ...
        <div class="col l5 m5 s12 webpro-left">
            <div class="webpro-pushpin-left hide-on-small-only">
                ...
                <nav class="webpro-nav-lvl2">
                    ...
                    <a class="webpro-subnav-active" href="/kurse/wordpress-themes-mit-gutenberg-editor/">WordPress Custom Post Types und Gutenberg-Editor</a><br>
        ...
        <div class="col l7 m6 webpro-right">
            <div id="beschreibung" class="section scrollspy">
                <p class="headline">
                    ...
                    Eigene Inhaltstypen erstellen und eigene Felder hinzufügen?
                    Du hast bereits eigene Themes mit Custom Post Types und Custom Fields entwickelt und möchtest diese und deine zukünftigen Projekte nun für den Gutenberg Editor fit machen?
                    Dann bist du bei diesem Kurs genau richtig!
                </p>
                <p>
                    Aktuell arbeitet die WordPress Entwickler Community mit Vollgas an der Version 5.0 welche auch den neuen <strong>"Gutenberg-Editor"</strong> beinhalten wird - eine Alpha-Version dieses Features ist auf April zu erwarten.
                    Dabei stehen nicht nur grössere Auswirkungen auf das Publishing von Inhalten an, sondern grundlegende Auswirkungen auf das Theme-Development sowie der Kompatibilität bisheriger Themes und Plugins.
                    Gemeinsam sehen wir uns die Änderungen in der kommenden Version an. Welche Neuerungen bringt der neue Editor? Was bedeutet dies für bestehende und für neue Wordpress Projekte? Inwiefern betrifft der neue Editor das bisherige Arbeiten mit Custom Fields und Custom Post Types?
                </p>
                <p>
                    Im Rahmen dieses Intensiv-Kurses erlernst du die Erstellung von Custom Post Types sowie deren Einsatz im eigenen Theme.
                    Um das Theme mit eigenen Feldern beliebig erweitern zu können mussten bisher Custom Fields eigensetzt deren Erstellung und
                    Ausgabe mit dem Plugin "acf Advanced Custom Fields" enorm erleichtert wurde. Doch was bedeutet dies neu mit dem Gutenberg Editor? Wie können wir die neuen Block-Elemente in unserem Theme hinzufügen?

                    https://videopress.com/v/DK5mLrbr?at=2162
                </p>
            </div>
            ...
            <div id="inhalte" class="section scrollspy">
                ...
                <ul class="webpro-list">
                    ...
                    <li>Was wird neu bei WordPress 5.0? Wie gehen wir im Theme-Development mit dem Gutenberg-Editor um? Wie sehen allfällige Migrationsmassnahmen bestehender Themes aus?</li>
                    <li>Erstellung von Custom Post Types inkl. Taxonomien</li>
                    <li>Ergänzung der CPT's durch die neuen Gutenberg Blocks (bisher mit Custom Fields)</li>
                    <li>Basiswissen Archive- und Single-Templates</li>
                    <li>Ausgabe der Custom Post Types und Content Blocks im Frontend</li>
            ...
            <div id="termine" class="section scrollspy">
                ...
                <p>5 Kursabende à 4 Lektionen (Total 20 Lektionen). Jeweils Montags von 18.15 Uhr bis 21.30 Uhr. Kursdaten: 23.04.2018 - 14.05.2018</p>
