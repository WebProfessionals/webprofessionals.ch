...
<div class="col l4 m6 s12">
    <div class="card z-depth-2 webpro-green small" itemscope itemtype="http://schema.org/Event">
        <div class="card-stacked">
            ...
            <div class="card-action">
                <a class="white-text" itemprop="url" href="https://www.facebook.com/events/176503209456245/" target="_blank">Facebook Event</a>
            </div>
        </div>
    </div>
</div>
    ...
    <div class="card z-depth-2 webpro-green small" itemscope itemtype="http://schema.org/Event">
        <div class="card-stacked">
            <div class="card-content white-text">
                ...
                <span class="card-events-date" itemprop="startDate" content="2016-09-24T10:30">24. September 2016</span><br>
                10:30 - 11:30 Uhr<br>
                <br>
                <span class="card-events-title" itemprop="name"><strong>Informationsanlass in Sargans SG</strong></span><br>
            ...
            <div class="card-action">
                <a class="white-text" itemprop="url" href="https://www.facebook.com/events/1108082952614796/" target="_blank">Facebook Event</a>
            </div>
        </div>
    </div>
</div>
