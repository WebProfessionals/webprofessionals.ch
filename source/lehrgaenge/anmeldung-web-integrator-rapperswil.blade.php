    ...
    <div class="row">
        ...
        <div class="col l7 m6 webpro-right">
            ...
            <form action="https://formspree.io/info@web-professionals.ch" method="POST">
                ...
                <input type="hidden" name="lehrgang" value="Web Integrator Rapperswil" />
                <input type="hidden" name="_subject" value="Anmeldung Web Integrator Rapperswil" />
                <input type="hidden" name="_next" value="https://web-professionals.ch/lehrgaenge/anmeldung-danke-web-integrator-rapperswil/" />
            </form>
