...
@section('body')
    ...
    <!-- Google Code for Anmeldung Web Developer Grabs Conversion Page -->
    <script type="text/javascript">
        ...
        var google_conversion_label = "mpF4CLnq3G4QsLrR0AM";
    ...
    <noscript>
        <div style="display:inline;">
            <img height="1" width="1" style="border-style:none;" alt="" src="//www.googleadservices.com/pagead/conversion/974413104/?label=mpF4CLnq3G4QsLrR0AM&amp;guid=ON&amp;script=0"/>
        </div>
    </noscript>
