    ...
    <div class="row">
        <div class="s12">
            ...
            <ul class="collapsible" data-collapsible="accordion">
                <li>
                    <div class="collapsible-header"><i class="material-icons right">alarm</i><strong>AUG</strong>16: letzte Plätze Herbst-Lehrgänge 2016</div>
                ...
                <li>
                    <div class="collapsible-header"><i class="material-icons right">done</i><strong>AUG</strong>16: neue Webseite online</div>
